...
var com = com||{}; // 定义common对象: 调用img资源，实现棋盘的静态布局
...
com.init = function (stype){
	...
	//z(com.initMap.join())			//在console中载入棋盘
}
...
// window.onload() window对象常用事件：文档加载完成后立即执行函数
...
//debug alert： console.log 打印运行中的obj
